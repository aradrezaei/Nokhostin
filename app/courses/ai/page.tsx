...
//                   <div className="relative">
//                     <select
//                       className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 focus:border-purple-500 text-gray-900 dark:text-white font-medium text-sm ps-5 py-3.5 rounded-xl transition-all focus:outline-none appearance-none nk-select pe-11"
//                       required
//                     >
