...
import {
  ...
  DuoDollarSign,
  DuoCheckCircle,
} from '@/components/icons/DuoIcons';
        ...
        <div className="mx-auto flex max-w-screen-xl flex-col items-center gap-20 px-6 lg:flex-row">
          ...
          "
              >
                <item.icon
                  size={28}
                  className={`${item.color} mb-6 inline-block transition-transform duration-150 ease-out group-hover:scale-110`}
                />
      ...
      <section className="border-t border-[#e6ecef] py-12 md:py-16 dark:border-[#26363d]">
        <div className="mx-auto max-w-screen-xl px-6">
          ...
          "
            ...
            `}
                >
                  <v.icon size={20} className={v.color || 'text-violet-600 dark:text-violet-400'} />
                </div>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row gap-16 items-center">
              <div className="lg:w-1/2">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    <div
                      key={i}
                      className="group flex items-start gap-4 text-[#61727a] dark:text-[#93a5ac]"
                    >
                      <DuoCheckCircle
                        size={20}
                        className="text-emerald-500 dark:text-emerald-400 flex-shrink-0 mt-0.5 transition-transform duration-150 ease-out group-hover:scale-110"
                      />
              ...
              <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                {benefits.map((benefit, i) => (
                  <div
                    key={i}
                    className="group p-6 rounded-2xl bg-white dark:bg-[#1d2d33]/50 border border-[#e6ecef] dark:border-[#2b3b42] transition-colors"
                  >
                    <benefit.icon
                      size={24}
                      className={`${benefit.color || 'text-violet-500 dark:text-violet-400'} mb-4 inline-block transition-transform duration-150 ease-out group-hover:scale-110`}
                    />
